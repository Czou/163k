...
function getPagingGlobal(obj,node){
	...
	function callback(data){
		...
		setTimeout(function(){$('#pagingList').html(data[0].MSG);},20);
...
function superManage(sid){
	...
	if(!window['hasSuperManag']){
		...
		'<div class="list">'+
			...
			'<span class="sp_b"><input type="radio" name="iszhiding" value="0" />否　<input type="radio" name="iszhiding" value="1" />是</span>'+
