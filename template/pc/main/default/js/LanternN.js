...
var Lantern={
    ...
    init: function(){
        ...
        for(var i=0;i<Lantern.info.length;i++)
        {
	        ...
	        divTemp.style.width="265px";
            divTemp.name=i;
	        divTemp.innerHTML="<div class='liclass' id='lanternnum"+i+"'>"+(i+1)+"</div><span id=\"__lanternNc"+i+"\" style=\"display:none\">&nbsp;"+Lantern.info[i][1]+"</span>";
	        if(i==0)
            {
    ...
    initNany:function(){
        ...
        onLength=265//;document.getElementById("LanternN0").offsetWidth;
        offLength=27;//(Lantern.width-onLength)/(Lantern.info.length-1)
        var numtemp=0;
    ...
    setNavy:function(i){
        ...
        var onLength,offLength
        onLength=265;//document.getElementById("LanternN"+i).offsetWidth
        offLength=27;//(Lantern.width-onLength)/(Lantern.info.length-1)
        var numtemp=0;
        for(var j=0;j<Lantern.info.length;j++)
        {
