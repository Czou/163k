...
function setPayment(arg){
   document.forms["Form11"].pmode_id.value=arg;
   document.forms["Form11"].action.value="";
   if("0801"==arg||"0802"==arg||"0803"==arg||"081"==arg){
   	document.forms["Form11"].action.value="input";
   }
   if("1100"==arg){
   	document.forms["Form11"].action.value="callerinput";
   }
   if("046"==arg){
   	document.forms["Form11"].action.value="input";
   }
