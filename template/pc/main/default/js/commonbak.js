...
function checkcontact(o)
{
	...
	var url="../request.aspx?action=addqiye&qiyeid="+escape(o.qiyeid.value)+"&chrtel="+escape(o.chrtel.value)+"&chrmark="+escape(o.chrmark.value)+"&chrname="+escape(o.chrname.value) ;
...
function setcommentnews(aa,bb)
{
	...
	function requestsetcommentnews()
	{
		if(xmlhttp.readyState==4)
		{
			if(xmlhttp.status==200)
			{
				$("#revert"+aa).html(xmlhttp.responseText);	
			}
		}
	}
}
function checkyuyue()
{
	...
	var url="../request.aspx?action=yuyue&chrname="+escape($$("chrname").value)+"&chraddress="+escape($$("chraddress").value)+"&chrtel="+escape($$("chrtel").value)+"&chrcode="+escape($$("chrcode").value);
	url = url +"&chremail="+escape($$("chremail").value) +"&chrmark="+escape($$("chrmark").value) +"&shopid="+escape($$("shopid").value) ;
	var  Digital=new  Date();
	Digital=Digital+40000;
	url=url+"&k="+(Digital);
...
function showduihuan(val){
	...
	if(is_login === '1'){
		$$("mask").style.display='';
		Demo_login('<div align=center><iframe src="duihuan.aspx?id='+val+'&tt='+new Date()+'" scrolling="no" frameBorder=0 width=935 height=580></iframe></div>',935,580,935,580)
	}else{
		alert('对不起，请先登录再申请兑换！');
		return false;
	}
...
function checkcompanycomment(){
	...
	if(document.getElementById("isLogin").value !== '1'){alert('对不起，请先登录再发表评论！');}
	
	addcompanycomment(chrname,chrpwd,$$("code").value,$$("chrmark").value,commentyouke,$$("shopid").value,$$("total_score").value,$$("score_1").value,$$("score_2").value,$$("score_3").value,$$("score_4").value);
	return false;
}
...
function showwybaoming(val,tt){
	...
	if(tt=="0"){
		$$("mask").style.display='';
		Demo_login('<div align=center><iframe src="../baoming.aspx?activeid='+val+'" scrolling="no" frameBorder=0 width=935 height=450></iframe></div>',935,450,935,450)	
	}
	else{
		if(document.getElementById('isLogin').value !== '1'){
						...
						$$("mask").style.display='';
						setCookie("nextcookie","2,"+val+"");
						window.location.href=nowdomain+"member/login.html?from="+(escape(window.location.href));
...
function delorder(id)
{
    if ( confirm("该操作将不可逆！\n您确定要取消订单吗？"))
    {
      	var url="../request.aspx?action=delorder&str1="+escape(id);
		var  Digital=new  Date();
		Digital=Digital+40000;
		url=url+"&k="+(Digital);
...
function delbudan(id)
{
    if ( confirm("该操作将不可逆！\n您确定要删除此补单吗？"))
    {
      	var url="../request.aspx?action=delbudan&str1="+escape(id);
		var  Digital=new  Date();
		Digital=Digital+40000;
		url=url+"&k="+(Digital);
		//window.open(url);
...
function delduihuan(id)
{
    if ( confirm("该操作将不可逆！\n您确定要取消此礼品兑换订单吗？"))
    {
      	var url="../request.aspx?action=delduihuan&str1="+escape(id);
		var  Digital=new  Date();
		Digital=Digital+40000;
		url=url+"&k="+(Digital);
		//window.open(url);
...
function checkbudan(o){
	...
	var url="../request.aspx?action=company&str1="+escape(o.chrshop.value);
	var  Digital=new  Date();
	Digital=Digital+40000;
	url=url+"&k="+(Digital);
...
function delbaoming(id)
{
    if ( confirm("该操作将不可逆！\n您确定要取消此次报名吗？"))
    {
      	var url="../request.aspx?action=delbao&str1="+escape(id);
		var  Digital=new  Date();
		Digital=Digital+40000;
		url=url+"&k="+(Digital);
...
function delrevert(id)
{
    if ( confirm("该操作将不可逆！\n您确定要删除此条点评吗？"))
    {
      	var url="../request.aspx?action=delrevert&str1="+escape(id);
		var  Digital=new  Date();
		Digital=Digital+40000;
		url=url+"&k="+(Digital);
...
function delactive(id)
{
    if ( confirm("该操作将不可逆！\n您确定要删除此条自发活动吗？"))
    {
      	var url="../request.aspx?action=delactive&str1="+escape(id);
		var  Digital=new  Date();
		Digital=Digital+40000;
		url=url+"&k="+(Digital);
			...
			if(xmlhttp.status==200)
			{
				if(xmlhttp.responseText=="1"){
					if(youke=="0"){
						...
						//$$("mask").style.display='';
						//Demo_login('<div align=center><iframe src="../member/register.html?login=login" scrolling="no" frameBorder=0 width=695 height=540></iframe></div>',695,540,695,540)
						window.location.href=WebSiteUrl+"member/login.html?from="+(escape(window.location.href));
						return false;
					}
				}
				else{
...
function checkaddlive(o){
	...
	trimspace($$("chrmobile"));
	trimspace($$("chrqq"));
	if($$("chrtel").value=="" && $$("chrmobile").value=="" ){
		alert("对不起,联系手机,联系电话必填一项!");
		$$("chrtel").focus();
		return false;
	}
	if($$("chrmobile").value!=""){
		if($$("chrmobile").value.length!=11 && $$("chrmobile").value.length!=8){
			alert("对不起,联系手机必须是8位或11位!");
			$$("chrmobile").focus();
			return false;
		}	
	}
...
function msyqresult(rencaiid,chraddress,chrdate,zhiweiid,chrman,chrtel,chrmark){
	var xmlhttp=createxmlhttp();
		...
		var  Digital=new  Date();
		Digital=Digital+40000;
		url="../request.aspx?action=mysq&rencaiid="+escape(rencaiid)+"&chraddress="+escape(chraddress)+"&chrdate="+escape(chrdate)+"&zhiweiid="+escape(zhiweiid)+"&chrman="+escape(chrman)+"&chrtel="+escape(chrtel)+"&chrmark="+escape(chrmark);
		url=url+"&k="+(Digital);
...
function showwytg(val){
	window.location.href=nowdomain+"zftg.html?a="+escape(val);	
	return false;
}
function showwytg1(val){
	window.location.href=sitedomainurl+"zftg.html?a="+escape(val);	
	return false;
}
...
function showotherlive(colname,keyword){
	...
	Demo_login('<div align=center><iframe src="../other.aspx?action=live&colname='+escape(colname)+'&keyword='+(keyword)+'&datetime='+new Date()+'" scrolling="no" frameBorder=0 width=600 height=300></iframe></div>',600,300,600,300)
}

function showjubaolive(id){
	document.getElementById("mask").style.display='';
	Demo_login('<div align=center><iframe src="../other.aspx?action=jubao&id='+escape(id)+'" scrolling="no" frameBorder=0 width=260 height=128></iframe></div>',260,128,260,128)
}
...
function jubaolivesave(str,o){
	...
	{ 
		...
		var url="request.aspx?action=jubao&id="+str+"&chrmark="+escape(chrmark);
		var  Digital=new  Date();
		url=url+"&k="+(Digital);
		url=url+"&k="+Digital;
...
function search114bianming(o){
	...
	var url="../request.aspx?action=search114&keyword="+escape(o.keyword114.value);
	var  Digital=new  Date();
	Digital=Digital+40000;
	url=url+"&k="+(Digital);
...
function submithezuo()
{
	...
	var url="../request.aspx?action=submithezuo&chrname="+escape(document.form1.chrname.value)+"&chrtel="+escape(document.form1.chrtel.value)+"&chrmark="+escape(document.form1.chrmark.value);
	var  Digital=new  Date();
	Digital=Digital+40000;
	url=url+"&k="+(Digital);
	...
	function requestdatasearch114()
	{
		if(xmlhttp.readyState==4)
		{
			if(xmlhttp.status==200)
			{
				...
				{
					$$("mask").style.display='';
					Demo_login('<div align=center><iframe src="voteyan.aspx?id='+tt+'" scrolling="no" frameBorder=0 width=600 height=210></iframe></div>',600,210,600,210)	
				}
				else{
					alert(xmlhttp.responseText);	
				}
...
function shoprenling(id){
	...
	if(document.getElementById('isLogin').value !== '1')
				{
					Demo_login('<div align=center><iframe src="../request.aspx?action=renling&id='+id+curl+'" scrolling="no" frameBorder=0 width=600 height=300></iframe></div>',600,300,600,300);
				}
				else{
					Demo_login('<div align=center><iframe src="../request.aspx?action=renling&id='+id+curl+'" scrolling="no" frameBorder=0 width=600 height=372></iframe></div>',600,372,600,372);
				}
}
...
function jirutuangou(tt){
	$$("mask").style.display='';
	Demo_login('<div align=center><iframe src="../request.aspx?action=addtg&id='+tt+'" scrolling="no" frameBorder=0 width=600 height=353></iframe></div>',600,353,600,353)	
}
...
function ShowIpAddress(val1,val2){if($$("chriparea")){xmlhttpget("../request.aspx?action=showip&aa="+escape(val1)+"&bb="+escape(val2),"","","","","","ShowIpAddress_eval(xmlhttp.responseText);","","");}}
...
function changestate(val,id)
{
	...
	{
		var url="../request.aspx?action=changetgorder&iskill="+val+"&id="+escape(id);
		var  Digital=new  Date();
		Digital=Digital+40000;
		url=url+"&k="+(Digital);
		var xmlhttp=createxmlhttp();
...
function changemystate(val,id)
{
	if(confirm("您确认要更改状态吗？"))
	{
		var url="../request.aspx?action=changemytgorder&iskill="+val+"&id="+escape(id);
		var  Digital=new  Date();
		Digital=Digital+40000;
		url=url+"&k="+(Digital);
		var xmlhttp=createxmlhttp();
...
function changemystatexx(val,id)
{
	if(confirm("您确认要更改状态吗？"))
	{
		var url="../request.aspx?action=changemytgorderxx&iskill="+val+"&id="+escape(id);
		var  Digital=new  Date();
		Digital=Digital+40000;
		url=url+"&k="+(Digital);
		var xmlhttp=createxmlhttp();
...
function changemystatett(val,id)
{
	if(confirm("您确认要更改状态吗？"))
	{
		var url="../request.aspx?action=changemytgordertt&iskill="+val+"&id="+escape(id);
		var  Digital=new  Date();
		Digital=Digital+40000;
		url=url+"&k="+(Digital);
		var xmlhttp=createxmlhttp();
...
function toupiao(dd,aa,bb,cc,name,tel)
{
	var url="../request.aspx?action=toupiao&voteid="+aa+"&code="+escape(dd)+"&xuanshouid="+escape(bb)+"&name="+escape(name)+"&tel="+escape(tel);
	var  Digital=new  Date();
	Digital=Digital+40000;
	url=url+"&k="+(Digital);
	var xmlhttp=createxmlhttp();
...
function submittgorder(val)
{
	...
	var kindid = document.getElementsByName("kindid");
...
function submitorder(val)
{
	...
	if(flag=="0")
	{
		...
		$("#have_login").show();
		var url="../request.aspx?action=addtgorder&payid="+$("input[name='kindid']:checked").val()+"&num="+escape(num)+"&tgid="+escape($("#tgid").val())+"&chrname="+escape(chrname)+"&chraddress="+escape(chraddress)+"&chrmark="+escape(chrmark)+"&chrtel="+escape(chrtel) + "&chrtela="+escape(chrtela);
		var  Digital=new  Date();
		//window.open(url);
		Digital=Digital+40000;
		url=url+"&k="+(Digital);
...
function checksmscode(aa)
{
	...
	var url="../request.aspx?action=show1&str1=3&str2="+escape(aa)+"&str3="+escape(bb)+"&str4="+escape(cc);
	var  Digital=new  Date();
	Digital=Digital+40000;
	url=url+"&k="+(Digital);
	xmlhttp.onreadystatechange=rechecksmscode;
	xmlhttp.open("GET",url,true);
	xmlhttp.send(null);
	function rechecksmscode()
	{
		if(xmlhttp.readyState==4)
		{
			if(xmlhttp.status==200)
...
function resendemail(aa,bb,cc)
{
	...
	var url="../request.aspx?action=show1&str1=1&str2="+escape(aa)+"&str3="+escape(bb)+"&str4="+escape(cc);
	var  Digital=new  Date();
	Digital=Digital+40000;
	url=url+"&k="+(Digital);
