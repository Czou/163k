...
$.fn.houseGallery = function(){
	...
	var arr = dialog_data.find('img'),len=arr.length,txt='',fristClass='',tPrev=$('#dialog_img_prev'),tNext=$('#dialog_img_next'),cellW=90,tIndex=0,pIndex=0,kyNum = len-7,yuNum = 0;
	...
	function showIMG(index){
		...
		dialog_img.attr('src',target.attr('href'));
