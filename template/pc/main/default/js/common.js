...
function showwybaoming(val,tt){
	if(tt=="1"){
		Demo_login('<div align=center><iframe src="../baoming.aspx?activeid='+val+'" scrolling="no" frameBorder=0 width=600 height=445></iframe></div>',600,445,600,445);
	}
	else{
...
function ShowIpAddress(val1,val2){if($$("chriparea")){xmlhttpget("../request.aspx?action=showip&aa="+encodeURIComponent(val1)+"&bb="+encodeURIComponent(val2),"","","","","","ShowIpAddress_eval(xmlhttp.responseText);","","");}}
...
{
	var url="../request.aspx?action=toupiao&voteid="+aa+"&code="+encodeURIComponent(dd)+"&xuanshouid="+encodeURIComponent(bb)+"&name="+encodeURIComponent(name)+"&tel="+encodeURIComponent(tel);
	var  Digital=new  Date();
	Digital=Digital+40000;
	url=url+"&k="+(Digital);
	var xmlhttp=createxmlhttp();
